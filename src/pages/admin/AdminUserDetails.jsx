                                    ...
                                    {slotGroup.tickets.map((t, tIdx) => {
                                       ...
                                       return (
                                          <tr key={tIdx} className={`group ${isWin ? 'bg-emerald-50/30' : ''}`}>
                                             ...
                                             <td className="py-1.5 px-0 border-r-2 border-b-2 border-[#1d4ed8] text-lg font-black font-condensed italic text-gray-950 leading-none text-center">
                                                {t.qty}
                                             </td>
                                             <td className="py-1.5 px-0 border-r-2 border-b-2 border-[#1d4ed8] text-sm font-black text-gray-950 italic leading-none text-center">
                                                {t.price}
                                             </td>
