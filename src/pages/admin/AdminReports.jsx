...
const AdminReports = () => {
  const reports = [
    ...
    { title: 'Wallet Transaction Log', desc: 'Complete history of all deposits and winnings.', date: 'Live Feed', icon: Calendar, color: 'text-[#6366f1]', bg: 'bg-[#eff6ff]' },
  ];
  ...
  return (
    <div className="space-y-10 pb-32 p-4 min-h-screen bg-[#f8f9fa]">
      ...
      <div className="border-[1.5px] border-[#4f46e5] rounded-[2.5rem] p-8 bg-white shadow-2xl relative overflow-hidden group">
         ...
         <div className="flex gap-4 items-center">
            ...
            <div className="flex-grow">
               ...
               <p className="text-[#4f46e5] font-black text-[10px] uppercase tracking-widest leading-none mt-1">SMS Lottery Insights</p>
            </div>
            <button className="bg-gray-50 border border-gray-100 p-3 rounded-2xl text-gray-400 hover:text-[#6366f1] hover:bg-[#eff6ff] transition-all">
               <Download size={20} />
            </button>
         </div>
      </div>
      ...
      <div className="space-y-6">
         ...
         <div className="space-y-4">
            {reports.map((report, idx) => (
               <div key={idx} className="bg-white rounded-[2.2rem] p-6 border border-gray-100 shadow-lg flex flex-col gap-6 active:scale-[0.98] transition-all group hover:border-[#6366f1]/20">
                  ...
                  <div className="flex gap-3 justify-end border-t border-gray-50 pt-5">
                     <button className="bg-gray-50 text-gray-500 px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-[#6366f1] hover:text-white transition-all">
      ...
      <div className="bg-gray-900 rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden group">
         <div className="absolute top-0 right-0 w-48 h-48 bg-[#6366f1]/20 rounded-full -mr-24 -mt-24 blur-[100px] group-hover:bg-[#6366f1]/40 transition-colors"></div>
         
         <div className="relative z-10 flex flex-col items-center text-center space-y-4">
            <div className="bg-[#6366f1] px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest shadow-xl shadow-[#6366f1]/20">Pro Insights</div>
            ...
            <button className="w-full bg-white text-gray-900 py-4 rounded-2xl font-black text-[12px] uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl active:scale-95 transition-all mt-4">
               Access Full Forecast <ChevronRight size={18} className="text-[#6366f1]" />
            </button>
         </div>
      </div>
