    ...
    <div className="space-y-6">
      ...
      <div className="mt-8 bg-gray-900 p-6 rounded-3xl border border-gray-800 shadow-2xl flex flex-col sm:flex-row justify-between items-center gap-4">
         <div className="text-center sm:text-left">
            <p className="text-sm font-black text-primary uppercase tracking-tight">Warning</p>
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Changes apply instantly to live tickets</p>
         </div>
         <button 
           onClick={handleSave}
           disabled={isSaving}
           className="w-full sm:w-auto bg-primary text-white px-10 py-4 rounded-2xl text-[12px] font-black uppercase tracking-widest flex items-center justify-center gap-3 active:scale-95 transition-all shadow-[0_10px_20px_-5px_rgba(255,0,77,0.4)] disabled:opacity-50"
         >
