...
const AdminControl = () => {
  ...
  return (
    <div className="space-y-10 pb-32 p-4 min-h-screen bg-[#f8f9fa]">
      ...
      <div className="border-[1.5px] border-primary rounded-[2.5rem] p-8 bg-gray-900 text-white shadow-2xl relative overflow-hidden group">
         ...
         <div className="flex gap-4 items-center mb-8">
            ...
            <div className="flex-grow">
               ...
               <p className="text-primary font-black text-[10px] uppercase tracking-widest leading-none mt-1">Live Draw Management</p>
            </div>
         </div>
         ...
         <div className="flex gap-4 justify-between bg-white/5 p-5 rounded-2xl border border-white/5">
            <div className="flex items-center gap-3">
               ...
               <span className="text-[10px] font-black uppercase tracking-widest text-primary-hover">Active Node Proxy</span>
            </div>
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-6">
           <div className="flex items-center gap-3 ml-2">
              <Gamepad2 className="text-primary-hover" size={20} />
                   ...
                   <div className="flex items-center gap-5 relative z-10">
                      ...
                      <div>
                         ...
                         <div className="flex items-center gap-2 mt-1">
                            <span className="text-[9px] text-primary-hover font-black uppercase tracking-widest">{item.status}</span>
        ...
        <div className="space-y-6 pt-4 border-t border-gray-100">
           ...
           <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl space-y-8">
              ...
              <button className="w-full h-16 bg-gray-900 text-white rounded-2xl font-black text-[12px] uppercase tracking-widest shadow-xl flex items-center justify-center gap-3 active:scale-95 transition-all shadow-black/10">
                 Apply Global Safeguards <ChevronRight size={20} className="text-primary-hover" />
              </button>
           </div>
        </div>
      </div>
