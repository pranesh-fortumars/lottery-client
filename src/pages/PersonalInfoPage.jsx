    ...
    <PageWrapper title="VERIFICATION DETAILS" showNav={false}>
      <div className="bg-slate-50 min-h-screen pb-24">
        ...
        <div className="bg-gradient-to-r from-violet-600 to-fuchsia-500 h-[70px] flex items-center px-4 text-white shadow-md relative z-10">
          ...
          <h1 className="text-xl font-bold tracking-tight uppercase ml-2">Payout Verification</h1>
        </div>
        ...
        <div className="p-6 space-y-6 max-w-lg mx-auto">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 p-4 rounded-2xl flex items-center gap-3 text-xs font-bold text-red-600 shadow-sm">
