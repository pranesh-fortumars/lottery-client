        ...
        <div className="p-10 bg-gradient-to-br from-[#2563eb] to-[#ff4d6a] relative overflow-hidden group">
         ...
         {!isAdmin && (
           <div className="px-6 -mt-10 relative z-20">
              <div className="relative rounded-[2rem] shadow-2xl overflow-hidden border-2 border-gray-900 bg-white/90 backdrop-blur-xl text-gray-900">
                 {/* Glass/Glow Effects */}
                 <div className="absolute inset-0 bg-gradient-to-br from-white/60 to-white/10 pointer-events-none"></div>
                 <div className="absolute -top-20 -right-20 w-48 h-48 bg-blue-100/60 rounded-full blur-3xl pointer-events-none"></div>
                 <div className="absolute -bottom-20 -left-20 w-48 h-48 bg-indigo-100/60 rounded-full blur-3xl pointer-events-none"></div>
                 
                 {/* Top: Total Balance */}
                 <div className="relative p-6 border-b border-gray-200/50 flex items-center justify-between group cursor-pointer hover:bg-gray-50/50 transition-all" onClick={() => navigate('/topup')}>
                    <div className="flex items-center gap-4">
                       <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:rotate-3 transition-transform border border-blue-900">
                          <Wallet size={24} />
                       </div>
                       <div>
                          <p className="text-[9px] font-black text-gray-500 uppercase tracking-[0.2em] leading-none mb-1">Total Available Balance</p>
                          <p className="text-3xl font-black text-gray-900 italic tracking-tighter drop-shadow-sm">₹ {user?.balance?.toLocaleString() || '0.00'}</p>
                       </div>
                    </div>
