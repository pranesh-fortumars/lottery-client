        ...
        {transactionGroups.length === 0 ? (
          ...
          <div className="space-y-12 max-w-4xl mx-auto">
            ...
            {transactionGroups.map((group) => (
               <div 
                  key={group.id} 
                  onClick={() => navigate(`/order-details/${group.id}`)}
                  className="bg-gray-950 rounded-3xl shadow-2xl border-2 border-black overflow-hidden cursor-pointer hover:border-gray-500 transition-colors"
               >
                                 ...
                                 {slotGroup.tickets.map((t, tIdx) => {
                                    ...
                                    return (
                                       <tr key={tIdx} className={`group border-b border-gray-800 last:border-b-0 ${isWin ? 'bg-emerald-900/20' : 'bg-gray-950'}`}>
                                          ...
                                          <td className="py-2 px-0 border-r border-gray-800 text-lg font-black font-condensed italic text-white leading-none text-center">
                                             {t.qty}
                                          </td>
                                          <td className="py-2 px-0 border-r border-gray-800 text-sm font-black text-white italic leading-none text-center">
                                             {t.price}
                                          </td>
